...
import com.smkn2.adapters.ViewPagerAdapter3;
...
public class RecyclerView3 extends AppCompatActivity {
	...
	private void setupToolbar(){
        toolbar.setTitle(getString(R.string.recycler_view_3_title));
		toolbar.setSubtitle(getString(R.string.recycler_view_3_subtitle));
    }
	...
	Runnable tabLayout_config = new Runnable()
	{
		...
		public void run()
		{
			...
			if(tabLayout.getWidth() < RecyclerView3.this.getResources().getDisplayMetrics().widthPixels)
			{
    ...
    private void setupViewPager(){
        viewPager.setAdapter(new ViewPagerAdapter3(getSupportFragmentManager()));
    }
