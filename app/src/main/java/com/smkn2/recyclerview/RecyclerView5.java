...
import com.smkn2.adapters.ViewPagerAdapter5;
...
public class RecyclerView5 extends AppCompatActivity {
	...
	private void setupToolbar(){
        toolbar.setTitle(getString(R.string.recycler_view_5_title));
		toolbar.setSubtitle(getString(R.string.recycler_view_5_subtitle));
    }
	...
	Runnable tabLayout_config = new Runnable()
	{
		...
		public void run()
		{
			...
			if(tabLayout.getWidth() < RecyclerView5.this.getResources().getDisplayMetrics().widthPixels)
			{
    ...
    private void setupViewPager(){
        viewPager.setAdapter(new ViewPagerAdapter5(getSupportFragmentManager()));
    }
