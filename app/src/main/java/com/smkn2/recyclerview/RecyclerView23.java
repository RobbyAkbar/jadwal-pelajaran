...
import com.smkn2.adapters.ViewPagerAdapter23;
import com.smkn2.cikarangbarat.R;

public class RecyclerView23 extends AppCompatActivity {
	...
	private void setupToolbar(){
        toolbar.setTitle(getString(R.string.recycler_view_23_title));
		toolbar.setSubtitle(getString(R.string.recycler_view_23_subtitle));
    }
	...
	Runnable tabLayout_config = new Runnable()
	{
		...
		public void run()
		{
			...
			if(tabLayout.getWidth() < RecyclerView23.this.getResources().getDisplayMetrics().widthPixels)
			{
