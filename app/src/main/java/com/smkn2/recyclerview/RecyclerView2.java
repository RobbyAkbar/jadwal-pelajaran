...
import com.smkn2.adapters.ViewPagerAdapter2;
...
public class RecyclerView2 extends AppCompatActivity {
	...
	private void setupToolbar(){
        toolbar.setTitle(getString(R.string.recycler_view_2_title));
		toolbar.setSubtitle(getString(R.string.recycler_view_2_subtitle));
    }
	...
	Runnable tabLayout_config = new Runnable()
	{
		...
		public void run()
		{
			...
			if(tabLayout.getWidth() < RecyclerView2.this.getResources().getDisplayMetrics().widthPixels)
			{
    ...
    private void setupViewPager(){
        viewPager.setAdapter(new ViewPagerAdapter2(getSupportFragmentManager()));
    }
